                        ...
                        <div class="items">
                            <div class="product">
                                <div class="row justify-content-center align-items-center">
                                    <div class="col-md-3">
                                        <div class="product-image"><img class="img-fluid d-block mx-auto image" src="${ped.evento.imagen}"></div>
                                    </div>
                                    <div class="col-md-5 product-info"><a class="product-name" href="#">${ped.evento.nombre}</a>
                                        <div class="product-specs">
                                            <div><span>Fecha:&nbsp;</span><span class="value">${ped.fecha}</span></div>
                                            <div><span>Estado:&nbsp;</span><span class="value">${ped.estado}</span></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6 col-md-2 price"><span>$${ped.monto}</span></div>
                                </div>
                            </div>
                        </div>
                    </g:each>
