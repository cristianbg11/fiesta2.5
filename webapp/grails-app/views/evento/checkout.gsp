                ...
                <div class="row no-gutters">
                        ...
                        <div class="items">
                            <div class="product">
                                <div class="row justify-content-center align-items-center">
                                    <div class="col-md-3">
                                        <div class="product-image"><img class="img-fluid d-block mx-auto image" src="${evento.imagen}"></div>
                                    </div>
                    ...
                    <div class="col-md-12 col-lg-4">
                        <div class="summary">
                            ...
                            <a href="/evento/payment/${evento.id}" class="btn btn-primary btn-block btn-lg">Checkout</a>
                        </div>
                    </div>
                </div>
            </div>
